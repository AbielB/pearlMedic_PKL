...
<body>
    ...
    <div class="container">
        ...
        <main id="mainmenu">
            ...
            <div class="container deleteakun">
                <i class="fa-solid fa-trash"></i>
                <h1>Sukses Menghapus Akun Perusahaan</h1>
                <p>Akun Perusahaan tersebut sudah dihapus dari database</p>
                <a href="dataperusahaan.php" class="btn btn-primary">Kembali</a>
            </div>
        </main>
